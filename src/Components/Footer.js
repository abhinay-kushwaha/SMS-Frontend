        ...
        <footer className="bg-black text-white py-8">
            <div className="container mx-auto px-4 flex flex-col lg:flex-row justify-between items-center">
                <div className="mb-8 lg:mb-0">
                    <h1 className="text-3xl font-bold">Shanti InfoSoft</h1>
                    <ul className="mt-4 space-y-2">
                        <li className="flex items-center">
                            <FaPhoneAlt className="mr-2" /> +91 9109039050
                        </li>
                        <li className="flex items-center">
                            <FaEnvelope className="mr-2" /> info@shantiinfosoft.in
                        </li>
                        <li className="flex items-center">
                            <FaMapMarkerAlt className="mr-2" /> 1st - 3rd floor, PU 4, Vijay Nagar Square, Behind C21 Mall, Scheme 54 PU4, Indore, Madhya Pradesh 452011
                        </li>
                    </ul>
                </div>
                <div >
                    <iframe
                        title="Volcanus Academy Location"
            ...
            <div className="container mx-auto px-4 flex flex-col lg:flex-row justify-between items-center mt-8">
                ...
                <p className="text-sm">&copy; 2024 ShantInfosoft. All Rights Reserved</p>
            </div>
        </footer>
    );
};
