...
const testimonials = [
    {
        quote: "Under the leadership of Rishabh Jain, Company Name has achieved remarkable growth and success. His vision drives the company forward.",
        author: "Rishabh Jain",
        authorTitle: "CEO",
    ...
    {
        quote: "Sagar Jain's strategic insights and collaborative approach make him an invaluable co-partner at Company Name.",
        author: "Sagar Jain",
  ...
  {
    quote: "We are thrilled with the results Company Name delivered. Their expertise in software development is unmatched, and they exceeded our expectations in every way.",
    author: "Priya Sharma",
  ...
  {
    quote: "Working with Company Name has been a game-changer for our business. Their innovative solutions have helped us stay ahead in the competitive market.",
    author: "Rahul Verma",
  ...
  {
    quote: "As the Training Head at Company Name, I have witnessed their commitment to nurturing talent and delivering exceptional training programs.",
    author: "Vipin Jain",
  ...
  {
    quote: "Company Name's commitment to excellence is evident in their work. They delivered our project on time and within budget, with exceptional results.",
    author: "Ananya Singh",
  ...
  {
    quote: "I highly recommend Company Name for their professionalism and dedication. They are reliable partners for any tech initiative.",
    author: "Vikram Mehta",
  ...
  {
    quote: "Company Name stands out for their proactive approach and technical expertise. They are responsive and deliver results that exceed expectations.",
    author: "Neha Kapoor",
